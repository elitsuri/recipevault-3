"""
RecipeVault 3 - Backend API
Recipe management platform with meal planning, shopping lists, and nutrition tracking
"""
...
app = FastAPI(
    title="RecipeVault 3",
    description="Recipe management platform with meal planning, shopping lists, and nutrition tracking",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "RecipeVault 3"}
